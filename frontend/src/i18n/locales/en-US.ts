export default {
  ...
  knowledgeBase: {
    ...
    batchSetTag: 'Set tag',
    batchSetTagTitle: 'Set tag for {count} documents',
    batchSetTagHint: 'The selected tag will overwrite the existing tag on all selected documents. Choose "No tag" to clear tags.',
    batchTagSuccess: 'Tag updated for {count} documents',
    batchTagFailed: 'Batch tag update failed',
    noTag: 'No tag',
